// Standalone omegaTarget service for the options page.
// Replaces the Angular-based omega_target_web.ts. This script runs
// before the Vue app and exposes omegaTarget as a global.
...
(function () {
  ...
  (window as any).omegaTarget = omegaTarget;
})();
